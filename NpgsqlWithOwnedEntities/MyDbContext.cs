...
namespace NpgsqlWithOwnedEntities
{
    ...
    {
        public static void MapSubstanceAsOwned<T>(this OwnedNavigationBuilder<T, Substance> ownedSubstanceBuilder)
            where T : class
        {
            ownedSubstanceBuilder.Property<uint>("xmin").HasColumnType("xid").HasColumnName("xmin")
                .ValueGeneratedOnAddOrUpdate().IsConcurrencyToken();
        ...
        public static void MapProductAsOwned<T>(this OwnedNavigationBuilder<T, Product> ownedProductBuilder)
            where T : class
        {
            ownedProductBuilder.Property<uint>("xmin").HasColumnType("xid").HasColumnName("xmin")
                .ValueGeneratedOnAddOrUpdate().IsConcurrencyToken();
        ...
        public static void MapCatalogItemInfoAsOwned<T>(
            this OwnedNavigationBuilder<T, CatalogItemInfo> ownedCatalogItemInfoBuilder) where T : class
        {
            ownedCatalogItemInfoBuilder.Property<uint>("xmin").HasColumnType("xid").HasColumnName("xmin")
                .ValueGeneratedOnAddOrUpdate().IsConcurrencyToken();
            ...
            {
                ownedSupplierInfoBuilder.Property<uint>("xmin").HasColumnType("xid").HasColumnName("xmin")
                    .ValueGeneratedOnAddOrUpdate().IsConcurrencyToken();
